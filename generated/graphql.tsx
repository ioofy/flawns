...
export type Mutation = {
  ...
  subCommentDelete: SubCommentPayload;
...
export type MutationSubCommentDeleteArgs = {
  subCommentId: Scalars['ID'];
};
...
export type DeleteCommentMutation = { __typename?: 'Mutation', commentDelete: { __typename: 'CommentPayload', userErrors: Array<{ __typename?: 'UserError', message: string }>, comment?: { __typename?: 'Comment', id: string, text: string } | null | undefined } };
...
export type SubCommentDeleteMutationVariables = Exact<{
  subCommentId: Scalars['ID'];
}>;


export type SubCommentDeleteMutation = { __typename?: 'Mutation', subCommentDelete: { __typename: 'SubCommentPayload', userErrors: Array<{ __typename?: 'UserError', message: string }>, subComment?: { __typename?: 'SubComment', id: string, text: string } | null | undefined } };
...
export type GetCommentsQuery = { __typename?: 'Query', getComments: { __typename?: 'CommentsConnection', cursor?: string | null | undefined, hasMore: boolean, comments: Array<{ __typename?: 'Comment', id: string, text: string, date?: any | null | undefined, user: { __typename?: 'User', id: string, name: string, username?: string | null | undefined }, subComments?: Array<{ __typename?: 'SubComment', id: string, user: { __typename?: 'User', username?: string | null | undefined } } | null | undefined> | null | undefined } | null | undefined> } };
...
export const SubCommentDeleteDocument = gql`
    mutation subCommentDelete($subCommentId: ID!) {
  subCommentDelete(subCommentId: $subCommentId) {
    __typename
    userErrors {
      message
    }
    ...
    `;
export type SubCommentDeleteMutationFn = Apollo.MutationFunction<SubCommentDeleteMutation, SubCommentDeleteMutationVariables>;

/**
 * __useSubCommentDeleteMutation__
 *
 * To run a mutation, you first call `useSubCommentDeleteMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSubCommentDeleteMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [subCommentDeleteMutation, { data, loading, error }] = useSubCommentDeleteMutation({
 *   variables: {
 *      subCommentId: // value for 'subCommentId'
 *   },
 * });
 */
export function useSubCommentDeleteMutation(baseOptions?: Apollo.MutationHookOptions<SubCommentDeleteMutation, SubCommentDeleteMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SubCommentDeleteMutation, SubCommentDeleteMutationVariables>(SubCommentDeleteDocument, options);
      }
export type SubCommentDeleteMutationHookResult = ReturnType<typeof useSubCommentDeleteMutation>;
export type SubCommentDeleteMutationResult = Apollo.MutationResult<SubCommentDeleteMutation>;
export type SubCommentDeleteMutationOptions = Apollo.BaseMutationOptions<SubCommentDeleteMutation, SubCommentDeleteMutationVariables>;
